...
const maleAvatars = [
  { id: 1, src: "/male_1.png" },
  { id: 2, src: "/male_2.png" },
  { id: 3, src: "/male_3.png", height: 800, width: 800, className: "h-24 sm:h-28 w-36 md:h-36" },
];

const femaleAvatars = [
  { id: 4, src: "/female_1.png" },
  { id: 5, src: "/female_2.png" },
  { id: 6, src: "/female_3.png", height: 800, width: 800, className: "h-24 sm:h-28 w-36 md:h-36" },
];
